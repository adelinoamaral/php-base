...
* ver configurações das diretivas file_uploads, uploads_max_filesize, upload_tmp_dir, post_max_size, max_input_time
...
<body>
	<div class="wrap">
		...
		<!-- 
			...
			Quando se pretende fazer download de vários ficheiro adiciona-se multiple="multiple"
		-->
