<?php
      ...
      /*
            ...
            Herança permite a reutilização de classes existentes em novas classes, 
            adquirindo os seus atributos e comportamentos, e complementando-os 
      ...
      */
      ...
      // A classe NoticiaPrincipal herda as propriedades e métodos da classe Noticia
      class NoticiaPrincipal extends Noticia 
      {
            public $imagem;

            /*
                  O método construtor da classe Noticia é executado automaticamente 
                  na subclasse NoticiaPrincipal.
                  
                  Outro detalhe importante: 
                  caso a subclasse NoticiaPrincipal tenha declarado um método 
