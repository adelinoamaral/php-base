        ...
        <table border="0" cellpadding="10" cellspacing="1" width="500" align="center">
            ...
            <tr class="tablerow">
                ...
                <td>
                    <select name="userType">
                        ...
                        <option value="Member"
                            <?php if(isset($_POST['userType']) && $_POST['userType']=="Member") { ?>selected<?php  } ?>>
                            Member</option>
                        <option value="Premium User"
                            <?php if(isset($_POST['userType']) && $_POST['userType']=="Premium User") { ?>selected<?php  } ?>>
                            Premium User</option>
                    </select>
                </td>
            </tr>
            <tr class="tablerow">
                ...
                <td><input type="text" name="displayName"
                        value="<?php if(isset($_POST['displayName'])) echo $_POST['displayName']; ?>"></td>
            </tr>
            <tr class="tablerow">
                <td align="right">Address</td>
                <td><textarea rows="3" cols="17"
                        name="userAddress"><?php if(isset($_POST['userAddress'])) echo $_POST['userAddress']; ?></textarea>
                </td>
            </tr>
