...
/*
 *
    Este script valida os campos do formulário e apresenta no próprio formulário
...
if($_SERVER["REQUEST_METHOD"] == "POST")
{
    ...
    /*
     *  verifica se inseriu o nome do cliente
        trim() retira espaços em branco no início e fim da string
    */
    ...
    /* 
        verifica se inseriu a morada do cliente
    */
    ...
    /* 
        valida o salário do cliente.
        ctype_digit() - checa caracteres numéricos
        is_numeric() - verifica se é numérico (inteiro ou real)
    */
     ...
     * 
        ...
        Os registos são guardados por ordem numérica.
    */
